...
// Ejemplo de métodos y atributos
        ...
        classInfo.addMethod("method2", new HashSet<>(Arrays.asList("attr1")));
        classInfo.addMethod("method3", new HashSet<>(Arrays.asList("attr1")));
        classInfo.addMethod("method4", new HashSet<>(Arrays.asList("attr2")));
        classInfo.addMethod("method5", new HashSet<>(Arrays.asList("attr2")));
        classInfo.addMethod("method6", new HashSet<>(Arrays.asList("attr1")));
        classInfo.addMethod("method7", new HashSet<>(Arrays.asList("attr1")));
        classInfo.addMethod("method8", new HashSet<>(Arrays.asList("attr1")));
        classInfo.addMethod("method9", new HashSet<>(Arrays.asList("attr2")));
